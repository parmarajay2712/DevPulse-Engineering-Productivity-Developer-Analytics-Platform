...
export interface IDailyMetric extends Document {
  ...
  timestamp: Date; // The day boundary (e.g., 2026-08-13T00:00:00.000Z)
  requestCount: number;
  errorCount: number;
...
DailyMetricSchema.index({ projectId: 1, endpoint: 1, timestamp: -1 }, { unique: true });

export default mongoose.model<IDailyMetric>('DailyMetric', DailyMetricSchema);
